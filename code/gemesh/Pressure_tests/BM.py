...
P_Eide *= -133*6./50    # Convert to Pa and make downwards

t_Erika = linspace(0,1.1,23)
P_Erika = array([-0.011,-0.03,-0.02, 0.002,0, 0,-0.003, -0.004,0, 0.002,0.004, 0.004, 0.005, 0.005,0.006, 0.006,0.006, 0.04, 0.05, 0.01, -0.01,-0.01,0])
P_Erika *= -6*133
