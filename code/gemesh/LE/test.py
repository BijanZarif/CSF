...
bcu3 = DirichletBC(VQW.sub(0),f,bnd,3)
...
# FLUID
kappa2 = 1.0#Constant(1.4*10**(-15)*(10**9))
phi2 = 1.0    # porosity
K_perm2 = kappa2/mu_f
...
LFV = rho_f/(k*phi2)*inner(u1,w)*dx(0,subdomain_data=SD) + \
	rho_f/k*inner(d1,w)*dx(0,subdomain_data=SD)

aFQ = -inner(div(u)+div(d),q)*dx(0,subdomain_data=SD)
