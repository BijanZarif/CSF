...
vf_l = MyExpression1(t_Brucker,C1_Brucker,0.0)
vf_r = MyExpression1(t_Brucker,C1_Brucker,0.0)
...
bcw9 = DirichletBC(VPW.sub(2),noslip,boundaries,9) # Fluid walls
bcw = [bcw1,bcw2,bcw3,bcw4,bcw5,bcw7,bcw9]
